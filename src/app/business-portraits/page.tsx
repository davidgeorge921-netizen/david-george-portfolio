...
export const metadata: Metadata = {
  ...
  description:
    "Executive headshots and personal-brand portraits by David George, in studio or on location across EMEA. Individual, executive and team sessions.",
  openGraph: {
    title: "Business Portraits | Stuttgart & EMEA | David George",
    description:
      "Executive headshots and personal-brand portraits, in studio or on location across EMEA.",
